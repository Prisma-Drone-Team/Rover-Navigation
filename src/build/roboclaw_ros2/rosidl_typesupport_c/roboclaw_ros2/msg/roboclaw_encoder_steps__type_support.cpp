...
static const _RoboclawEncoderSteps_type_support_symbol_names_t _RoboclawEncoderSteps_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, roboclaw_ros2, msg, RoboclawEncoderSteps)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, roboclaw_ros2, msg, RoboclawEncoderSteps)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, roboclaw_ros2, msg, RoboclawEncoderSteps)() {
  return &::roboclaw_ros2::msg::rosidl_typesupport_c::RoboclawEncoderSteps_message_type_support_handle;
}
