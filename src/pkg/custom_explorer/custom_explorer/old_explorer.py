...
class ExplorerNode(Node):
    def __init__(self):
        ...
        self.map_sub = self.create_subscription(
            OccupancyGrid, '/rover/global_costmap/costmap', self.map_callback, 10)

        # Action client for navigation
        self.nav_to_pose_client = ActionClient(self, NavigateToPose, 'rover/navigate_to_pose')
    ...
    def navigation_complete_callback(self, future):
        ...
        try:
            ...
            # Aspetta 10 secondi prima di esplorare di nuovo
            # self.get_logger().info("Aspetto 10 secondi prima del prossimo obiettivo...")
            # self.create_timer(10.0, self.explore_once, callback_group=None)
