...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        DeclareLaunchArgument('depth', default_value=ConditionalText('true', 'true', IfCondition(PythonExpression(["'", LaunchConfiguration('stereo'), "' == 'true'"]))._predicate_func(context)), description=''),
        ...
        DeclareLaunchArgument('Grid/3D', default_value='"false"', description=''),
        DeclareLaunchArgument('Grid/PreVoxelFiltering', default_value='"true"', description=''),
        DeclareLaunchArgument('Grid/ScanDecimation', default_value='"2"', description=''),
        DeclareLaunchArgument('GridGlobal/FloodFillDepth', default_value='"0"', description=''),
        DeclareLaunchArgument('Grid/MinClusterSize', default_value='"20"', description=''),
        DeclareLaunchArgument('Grid/ClusterRadius', default_value='"0.2"', description=''),


        DeclareLaunchArgument('Grid/RangeMax', default_value='"3.0"', description=''),
        DeclareLaunchArgument('Grid/RangeMin', default_value='"0.3"', description=''),
        DeclareLaunchArgument('Grid/MaxObstacleHeight', default_value='"0.5"', description=''),
        DeclareLaunchArgument('Grid/CellSize', default_value='"0.05"', description=''),
        DeclareLaunchArgument('Grid/NoiseFilteringMinNeighbors', default_value='"2"', description=''),
        DeclareLaunchArgument('Grid/NoiseFilteringRadius', default_value='"0.3"', description=''),
        ...
        DeclareLaunchArgument('Grid/FootprintHeight', default_value='"0.1"', description=''),
        DeclareLaunchArgument('GridGlobal/FootprintRadius', default_value='"0.7"', description=''),
        DeclareLaunchArgument('scan_cloud_max_points', default_value='1000', description=''),
        DeclareLaunchArgument('DetectionRate', default_value='"10.0"', description=''),
        DeclareLaunchArgument('Grid/MaxGroundHeight', default_value='"0.002"', description=''),
        DeclareLaunchArgument('Grid/MinGroundHeight', default_value='"-0.1"', description=''),
        ...
        DeclareLaunchArgument('MapUpdateRate', default_value='"20.0"', description=''),
        DeclareLaunchArgument('GridGlobal/MinSize', default_value="'30'", description=''),
        ...
        Node(
            ...
            parameters=[{
                ...
                "GridGlobal/MinSize": LaunchConfiguration('GridGlobal/MinSize'),                 
                ...
                # "Grid/MinGroundHeight" : LaunchConfiguration('Grid/MinGroundHeight'),
                ...
                # "Grid/3D" : LaunchConfiguration('Grid/3D'),
                "Grid/PreVoxelFiltering" : LaunchConfiguration('Grid/PreVoxelFiltering'),
                "Grid/ScanDecimation" : LaunchConfiguration('Grid/ScanDecimation'),
                "Grid/MinClusterSize" : LaunchConfiguration('Grid/MinClusterSize'),
                "Grid/ClusterRadius" : LaunchConfiguration('Grid/ClusterRadius'),
                "GridGlobal/FloodFillDepth" : LaunchConfiguration('GridGlobal/FloodFillDepth'),


                "Mem/IncrementalMemory": ConditionalText("true", "true", IfCondition(PythonExpression(["'", LaunchConfiguration('localization'), "' != 'true'"]))._predicate_func(context)).perform(context),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('map_topic',      default_value='/rover/map',                description='Map topic name.'),
        DeclareLaunchArgument('publish_tf_map', default_value='true',               description='Publish TF between map and odomerty.'),
        DeclareLaunchArgument('namespace',      default_value='rover',            description=''),
        ...
        DeclareLaunchArgument('topic_queue_size', default_value='16',                description='Queue size of individual topic subscribers.'),
        DeclareLaunchArgument('queue_size',     default_value='16',                 description='Backward compatibility, use "sync_queue_size" instead.'),
        ...
        DeclareLaunchArgument('output_goal_topic', default_value='/rover/goal_pose',      description='Output goal topic (can be connected to nav2).'),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/rover/camera/color/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/rover/camera/aligned_depth_to_color/image_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/rover/camera/color/camera_info',            description=''),
        ...
        DeclareLaunchArgument('rgbd_topic',       default_value='/rover/camera/depth/image_raw', description=''),
        ...
        DeclareLaunchArgument('scan_topic',           default_value='/rover/scan',       description=''),
        DeclareLaunchArgument('subscribe_scan_cloud', default_value='true',       description=''),
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/rover/camera/depth/color/points', description=''),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/rover/odom',  description='Odometry topic name.'),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/rover/imu/data', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
