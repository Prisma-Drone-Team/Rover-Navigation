...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        DeclareLaunchArgument('Grid/MaxGroundHeight', default_value='"0.02"', description=''),
        DeclareLaunchArgument('Grid/MinGroundHeight', default_value='"-0.15"', description=''),
        ...
        DeclareLaunchArgument('GridGlobal/MinSize', default_value="'10'", description=''),
