...
class Realsense(Node):
    ...
    def __init__(self):
        ...
        self.image_sub = message_filters.Subscriber(self, Image, '/camera/color/image_raw',qos_profile=qos_profile_image)
        self.pointcloud_sub = message_filters.Subscriber(self, PointCloud2, '/camera/depth/color/points',qos_profile=qos_profile_pc)
