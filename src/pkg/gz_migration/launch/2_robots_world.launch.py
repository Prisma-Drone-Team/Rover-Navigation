...
def generate_launch_description():
        ...
        bridge = Node(
            ...
            'qos_overrides./robot2/color/image_raw.publisher.reliability': 'best_effort',
            'qos_overrides./robot2/color/image_raw.subscription.reliability': 'best_effort',
            'qos_overrides./robot2/color/camera_info.publisher.reliability': 'best_effort',
            'qos_overrides./robot2/color/camera_info.subscription.reliability': 'best_effort',
            'qos_overrides./robot2/depth/image_raw.publisher.reliability': 'best_effort',
            'qos_overrides./robot2/depth/image_raw.subscription.reliability': 'best_effort',
            'qos_overrides./robot2/depth/camera_info.publisher.reliability': 'best_effort',
            'qos_overrides./robot2/depth/camera_info.subscription.reliability': 'best_effort',
            'qos_overrides./robot2/depth/image_raw/points.publisher.reliability': 'best_effort',
            'qos_overrides./robot2/depth/image_raw/points.subscription.reliability': 'best_effort',
