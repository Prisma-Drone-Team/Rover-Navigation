...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        #DeclareLaunchArgument('scan_cloud_max_points', default_value='10000', description=''),
        ...
        DeclareLaunchArgument('Grid/FlatObstacleDetectedAngle', default_value='"30"', description=''),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='robot2/base_link',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        ...
        DeclareLaunchArgument('depth_topic',         default_value='/robot2/depth/image_raw/points', description=''),
        ...
        DeclareLaunchArgument('rgbd_topic',       default_value='/robot2/depth/camera_info', description=''),
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/robot2/scan/points', description=''),
