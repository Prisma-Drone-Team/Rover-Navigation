...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        DeclareLaunchArgument('Rtabmap/DetectionRate', default_value='"10.0"', description=''),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='robot2/base_footprint',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        DeclareLaunchArgument('odom_frame_id',  default_value='',                   description='If set, TF is used to get odometry instead of the topic.'),
        DeclareLaunchArgument('map_frame_id',   default_value='robot2/map',                description='Output map frame id (TF).'),
        DeclareLaunchArgument('map_topic',      default_value='/robot2/map',                description='Map topic name.'),
        ...
        DeclareLaunchArgument('output_goal_topic', default_value='/robot2/goal_pose',      description='Output goal topic (can be connected to nav2).'),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/robot2/odom',  description='Odometry topic name.'),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/robot2/imu/data', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
