...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        DeclareLaunchArgument('qos_odom',        default_value='1', description='Specific QoS used for odometry input data: 0=system default, 1=Reliable, 2=Best Effort.'),
        ...
        DeclareLaunchArgument('Grid/Sensor', default_value='"false"', description=''),
        DeclareLaunchArgument('Grid/RangeMax', default_value='"10.0"', description=''),
        DeclareLaunchArgument('Grid/RangeMin', default_value='"0.0"', description=''),
        ...
        DeclareLaunchArgument('Grid/Scan2d', default_value='"true"', description=''), 
        ...
        DeclareLaunchArgument('Grid/FromDepth', default_value='"true"', description=''),
        ...
        DeclareLaunchArgument('Rtabmap/DetectionRate', default_value='"2.0"', description=''),
        DeclareLaunchArgument('Grid/MaxGroundHeight', default_value='"0.27"', description=''),

        DeclareLaunchArgument('Rtabmap/StartNewMapOnLoopClosure', default_value='"true"', description=''),
        DeclareLaunchArgument('Mem/IncrementalMemory', default_value='"true"', description=''),
        DeclareLaunchArgument('Reg/Force3DoF', default_value='"true"', description=''),
        DeclareLaunchArgument('RGBD/LoopClosureReextractFeatures', default_value='"true"', description=''),
        ...
        DeclareLaunchArgument('GridGlobal/MinSize', default_value="'50'", description=''),
        DeclareLaunchArgument('GridGlobal/UpdateError', default_value='"10.5"', description=''),
        ...
        Node(
            ...
            parameters=[{
                ...
                # "Grid/Scan2d": LaunchConfiguration('Grid/Scan2d'),
                # "Rtabmap/DetectionRate" : LaunchConfiguration('Rtabmap/DetectionRate'),
                ...
                # "Rtabmap/StartNewMapOnLoopClosure" : LaunchConfiguration('Rtabmap/StartNewMapOnLoopClosure'),
                ...
                # "Grid/FromDepth" : LaunchConfiguration('Grid/FromDepth'),
                # "Reg/Force3DoF" : LaunchConfiguration('Reg/Force3DoF'),
                # "RGBD/LoopClosureReextractFeatures" : LaunchConfiguration('RGBD/LoopClosureReextractFeatures'),
                ...
                "Mem/InitWMWithAllNodes": ConditionalText("true", "true", IfCondition(PythonExpression(["'", LaunchConfiguration('localization'), "' == 'true'"]))._predicate_func(context)).perform(context)
            }],
            remappings=[
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('output_goal_topic', default_value='/robot1/goal_pose',      description='Output goal topic (can be connected to nav2).'),
        ...
        DeclareLaunchArgument('odom_topic',                 default_value='/robot1/odom',  description='Odometry topic name.'),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/robot1/imu/data', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
