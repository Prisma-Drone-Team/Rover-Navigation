...
class Odometry : public rclcpp::Node{
    ...
    private:
        void topic_callback(const tf2_msgs::msg::TFMessage::SharedPtr msg){
            ...
            double start_x=-17.0; //-35
            double start_y=15.0; //35
            double start_z=13.0; //-2
            ...
            new_odom_.child_frame_id = child_frame_;            new_odom_.pose.pose.position.x = transform_.transforms[7].transform.translation.x - start_x;
