...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        DeclareLaunchArgument('Grid/MaxObstacleHeight', default_value='"0.3"', description=''),
        DeclareLaunchArgument('Grid/CellSize', default_value='"0.03"', description=''),
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/camera/depth/color/points', description=''),
