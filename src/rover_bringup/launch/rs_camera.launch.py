...
configurable_parameters = [{'name': 'camera_name',                  'default': 'rover_camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '0,0,15', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '0,0,15', 'description': 'depth stream profile'},
