...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frame_id',       default_value='rover/base_link',          description='Fixed frame id of the robot (base frame), you may set "base_link" or "base_footprint" if they are published. For camera-only config, this could be "camera_link".'),
        ...
        DeclareLaunchArgument('map_topic',      default_value='rtabmap/rtabmap/map',                description='Map topic name.'),
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/rover_camera/color/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/rover_camera/depth/image_rect_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/rover_camera/color/camera_info',            description=''),
        ...
        DeclareLaunchArgument('rgbd_topic',       default_value='/rover_camera/color/image_raw', description=''),
        ...
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/rover_camera/depth/color/points', description=''),
